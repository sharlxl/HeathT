...
const Button = (props) => {
  ...
  return (
    <button
      title={props.title}
      type={props.type}
      onClick={props.onClick ? props.onClick : onClickPlaceholder}
      className="m-1 float-right relative inline-flex items-center justify-start px-5 py-1 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group"
    >
